wget -N https://github.com/JieJiSS/dnsmasq-china-list/raw/master/accelerated-domains.china.conf
echo '# Converted from https://github.com/JieJiSS/dnsmasq-china-list/blob/master/accelerated-domains.china.conf' >dnscrypt-forwarding-rules.txt
echo '# https://github.com/JieJiSS/dnsmasq-china-list' >>dnscrypt-forwarding-rules.txt
...
wget -N https://github.com/JieJiSS/dnsmasq-china-list/raw/master/bogus-nxdomain.china.conf
echo '# Converted from https://github.com/JieJiSS/dnsmasq-china-list/blob/master/bogus-nxdomain.china.conf' >dnscrypt-blacklist-ips.txt
echo '# https://github.com/JieJiSS/dnsmasq-china-list' >>dnscrypt-blacklist-ips.txt
